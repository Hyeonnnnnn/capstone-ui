...
<head>
    ...
    <title>JBC Fitness Gym - Admin Dashboard</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-header">
            ...
            <div class="user-initials">A.A.</div>
            <p class="welcome-text">Welcome!</p>
            <h4>Admin Account <span class="admin-badge">Admin</span></h4>
            ...
            <a href="sidebar.php?page=manage_customers" class="menu-item" data-title="Manage Customers" data-page="manage_customers">
                <i class="fas fa-users"></i> <span class="menu-text">Manage Customers</span>
            </a>
            <a href="sidebar.php?page=manage_plans" class="menu-item" data-title="Manage Plans" data-page="manage_plans">
                <i class="fas fa-dumbbell"></i> <span class="menu-text">Manage Plans</span>
            </a>
            ...
            <a href="sidebar.php?page=manage_clerk_accounts" class="menu-item" data-title="Manage Clerk Accounts" data-page="manage_clerk_accounts">
                <i class="fas fa-user-tie"></i> <span class="menu-text">Manage Clerk Accounts</span>
            </a>
            ...
            <a href="sidebar.php?page=logs" class="menu-item" data-title="Logs" data-page="logs">
                <i class="fas fa-clipboard-list"></i> <span class="menu-text">Logs</span>
            </a>
    ...
    <div class="content-wrapper" style="padding-top: 0 !important; margin-top: 0 !important;">
        ...
        <div class="page-content" style="margin-top: 0 !important; padding-top: 0 !important;">
            ...
            switch($page) {
                ...
                case 'manage_plans':
                    include "manage_plans/index.php";
                    break;
                ...
                case 'manage_clerk_accounts':
                    include "manage_clerk_accounts/index.php";
                    break;
    ...
    </div>    <!-- Include jQuery first (if not already included) -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Include Bootstrap JS -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
      <!-- Include our utility JavaScript files with full paths -->
