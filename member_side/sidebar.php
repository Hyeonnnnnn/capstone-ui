...
<head>
    ...
    <!-- Additional styles for content wrapper -->    <style>        .content-wrapper {
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-header">
            ...
            <div class="user-initials">J.D.</div>
            <p class="welcome-text">Welcome!</p>
            <h4>John Doe <span class="member-badge">Member</span></h4>
        </div>
          <div class="sidebar-menu">
            ...
            <a href="sidebar.php?page=membership" class="menu-item" data-title="Membership" data-page="membership">
                <i class="fas fa-id-card"></i> <span class="menu-text">Membership</span>
            </a>
            <a href="sidebar.php?page=track_attendance" class="menu-item" data-title="Track Attendance" data-page="track_attendance">
        ...
        <div class="page-header" style="margin-top: 0 !important; padding-top: 0 !important;">
          ...
          <div class="page-content" style="margin-top: 0 !important; padding-top: 0 !important;">
            ...
            switch($page) {
                ...
                case 'track_attendance':
                    include "track_attendance/index.php";
                    break;
